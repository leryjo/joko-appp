...
ENV DEBIAN_FRONTEND=noninteractive \
    ...
    DATA_DIR=/joko-app/data \
    PROFILES_ROOT=/joko-app/data/chrome_profiles \
...
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    nano vim-tiny less fonts-liberation \
...
RUN chmod +x /joko-app/entrypoint.sh /joko-app/login /joko-app/startloop /joko-app/stoploop && \
    ...
    touch /joko-app/data/email.txt /joko-app/data/emailshare.txt /joko-app/data/mapping_profil.txt \
          ...
          /joko-app/data/hasil.txt /joko-app/data/akun_bermasalah.txt /joko-app/data/loop_status.json
